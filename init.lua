...
vim.keymap.set('n', '<leader>sr', require('telescope.builtin').resume, { desc = '[S]earch by [G]rep' })
...
vim.keymap.set('n', '<leader>q', function() vim.lsp.buf.code_action() end, { desc = '[q] Apply quick fix' })
